...
<div class="container-sm">
    ...
    <div class="row">
        ...
        <div class="col align-items-center">
            ...
            <form method="POST" action="<?=$base;?>/meus-dados" enctype="multipart/form-data" id="userConfig">
                ...
                <div  class="form-group">
                    ...
                    <input id="email" type="email" name="email" class="form-control" placeholder="Digite seu E-mail" value="<?=$user->email;?>">
